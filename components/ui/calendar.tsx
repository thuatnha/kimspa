  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: "bg-[#fdc700] text-black hover:bg-[#fdc700] hover:text-black focus:bg-[#fdc700] focus:text-black",
        day_today: "bg-accent text-accent-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
        day_disabled: "text-muted-foreground opacity-50 color-[#dddddd]",
